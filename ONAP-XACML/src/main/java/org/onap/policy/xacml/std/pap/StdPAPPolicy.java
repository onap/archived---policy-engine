...
public class StdPAPPolicy implements OnapPAPPolicy, Serializable{
    ...
    public StdPAPPolicy(StdPAPPolicyParams stdPAPPolicyParams){
        this(stdPAPPolicyParams.getConfigPolicyType(), stdPAPPolicyParams.getPolicyName(), stdPAPPolicyParams.getDescription(), stdPAPPolicyParams.getOnapName(), stdPAPPolicyParams.getConfigName(), stdPAPPolicyParams.getAttributes(), stdPAPPolicyParams.getConfigType(),
                stdPAPPolicyParams.getBody(), stdPAPPolicyParams.getEditPolicy(), stdPAPPolicyParams.getDomain(), 1, stdPAPPolicyParams.getRiskLevel(), stdPAPPolicyParams.getRiskType(), stdPAPPolicyParams.getGuard(), stdPAPPolicyParams.getTtlDate());
    }
