...
public class StdPAPPolicy implements OnapPAPPolicy, Serializable {
    ...
    public StdPAPPolicy(StdPAPPolicyParams stdPAPPolicyParams) {
        this(stdPAPPolicyParams.getConfigPolicyType(), stdPAPPolicyParams.getPolicyName(),
                stdPAPPolicyParams.getDescription(), stdPAPPolicyParams.getOnapName(),
                stdPAPPolicyParams.getConfigName(), stdPAPPolicyParams.getAttributes(),
                stdPAPPolicyParams.getConfigType(),
                stdPAPPolicyParams.getBody(), stdPAPPolicyParams.getEditPolicy(), stdPAPPolicyParams.getDomain(), 1,
                stdPAPPolicyParams.getRiskLevel(), stdPAPPolicyParams.getRiskType(), stdPAPPolicyParams.getGuard(),
                stdPAPPolicyParams.getTtlDate());
    }
    ...
    public StdPAPPolicy(String configPolicyType, String policyName, String description, String onapName,
                        String configName, Map<String, String> attributes, String configType,
                        String body, Boolean editPolicy, String domain, int highestVersion, String riskLevel,
