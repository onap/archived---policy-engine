...
public class JPAUtils {
	 ...
	 */
	public static JPAUtils getJPAUtilsInstance(EntityManagerFactory emf) throws IllegalStateException{
	 ...
	 */
	public static JPAUtils getJPAUtilsInstance() throws IllegalStateException{
