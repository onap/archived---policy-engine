...
public class FirewallConfigPolicy extends Policy {
   ...
   //Utility to read json data from the existing file to a string
                ...
                for (int i = 0; i<jsonDiff.size(); i++) {
                    ...
                    if (path.contains("firewallRuleList")) {
                        ...
                        for(int ri = 0; ri < firewallRules.size(); ri++) {
                             ...
                             * Create Queries to INSERT data into database tables and execute
                             */
                            saveTermListToDb(dbConnection, ruleName, action, description, fromZoneInsert, toZoneInsert, srcListInsert, destListInsert, destPortListInsert);
    ...
    private void saveTermListToDb(CommonClassDaoImpl dbConnection, String ruleName, String action, String description, String fromZoneInsert, String toZoneInsert, String srcListInsert, String destListInsert, String destPortListInsert) {
        UserInfo userInfo = new UserInfo();
        userInfo.setUserLoginId("API");
        userInfo.setUserName("API");
