...
public class MicroServiceConfigPolicy extends Policy {
    ...
    private String getValueFromDictionary(String service) {
        ...
        List<Object> result = dbConnection.getDataById(MicroServiceModels.class,
    ...
    protected AdviceExpressionsType getAdviceExpressions(int version, String fileName) {
        ...
        if (matchMap == null || matchMap.isEmpty()) {
            ...
            assignment6
                .setExpression(new ObjectFactory().createAttributeValue(configNameAttributeValue6));
            ...
            assignment8
                .setExpression(new ObjectFactory().createAttributeValue(configNameAttributeValue8));
            ...
            assignment9
                .setExpression(new ObjectFactory().createAttributeValue(configNameAttributeValue9));
