...
public class MicroServiceDictionaryController {
    ...
    private static String ruleFormation = "ruleFormation";
    private static String microServiceDictNameDatas = "microServiceDictionaryDatas";
    ...
    public ModelAndView saveDictionaryData(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (fromAPI) {
                ...
                utils.setResponseData(response, microServiceDictNameDatas, responseString);
            }
        } catch (Exception e) {
            utils.setErrorResponseData(response, e);
        }
            ...
            if (root.has("modelType")) {
                ...
                if (modelType.contains("yml")) {
                    if (root.has(microServiceModelsDictionaryData)) {
                        ...
                        if (root.has(ruleFormation)) {
                            microServiceModels.setRuleFormation(root.get("ruleFormation").asText().replace("\"", ""));
                            this.newModel.setRuleFormation(microServiceModels.getRuleFormation());
                        }
                    }
