...
public class PolicyScopeDictionaryControllerTest {
    ...
    public void testUpdatePSGroupScopeDictionary() {
        jsonString =
                "{\"groupPolicyScopeListData\":{\"id\":1,\"description\":\"test\",\"groupName\":\"Test\"},\"groupPolicyScopeListData1\":{\"closedloop\":\"SampleClosedLoop\",\"resource\":\"SampleResource\",\"service\":\"SampleService\",\"type\":\"SampleType\"},\"userid\":\"demo\"}";
        try (BufferedReader br = new BufferedReader(new StringReader(jsonString))) {
            when(request.getReader()).thenReturn(br);
            controller.savePSGroupScopeDictionary(request, response);
            assertTrue(response.getContentAsString() != null
    ...
    public void testSavePSClosedLoopDictionary() {
        jsonString =
                "{\"userid\":\"demo\",\"psClosedLoopDictionaryData\":{\"id\":1,\"description\":\"test\",\"name\":\"Test\"}}";
        try (BufferedReader br = new BufferedReader(new StringReader(jsonString))) {
            when(request.getReader()).thenReturn(br);
    ...
    public void testSavePSServiceDictionary() {
        jsonString =
                "{\"userid\":\"demo\",\"psServiceDictionaryData\":{\"id\":1,\"description\":\"test\",\"name\":\"Test\"}}";
        try (BufferedReader br = new BufferedReader(new StringReader(jsonString))) {
            when(request.getReader()).thenReturn(br);
    ...
    public void testUpdatePSResourceDictionary() {
        jsonString =
                "{\"userid\":\"demo\",\"psResourceDictionaryData\":{\"id\":1,\"description\":\"test\",\"name\":\"Test\"}}";
        try (BufferedReader br = new BufferedReader(new StringReader(jsonString))) {
            when(request.getReader()).thenReturn(br);
            controller.savePSResourceDictionary(request, response);
            assertTrue(response.getContentAsString() != null
