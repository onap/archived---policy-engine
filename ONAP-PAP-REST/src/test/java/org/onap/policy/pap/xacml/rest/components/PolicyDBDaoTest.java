...
public class PolicyDBDaoTest {
    ...
    private static void setupH2DBDaoImpl() {
        BasicDataSource dataSource = new BasicDataSource();
        dataSource.setDriverClassName("org.h2.Driver");
        dataSource.setUrl("jdbc:h2:mem:testdbdao;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE");
        // dataSource.setUrl("jdbc:h2:file:./sql/xacmlTest;DB_CLOSE_DELAY=-1");
