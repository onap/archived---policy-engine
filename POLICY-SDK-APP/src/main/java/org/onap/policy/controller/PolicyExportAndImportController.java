...
public class PolicyExportAndImportController extends RestrictedBaseController {
                ...
                while (cellIterator.hasNext()) {
                    ...
                    if (finalColumn && configurationBodySet) {
                        ...
                        if (policyEntity.getPolicyName().contains(CONFIG_MS)) {
                            ...
                            errorMsg = validatMatchRequiredFields(policyEntity.getPolicyName(), body.toString());
                            if (errorMsg != null) {
                        ...
                        if (roles.contains(superAdmin) || roles.contains(superEditor)) {
                            ...
                            PolicyEditorScopes policyEditorScope =
                                    (PolicyEditorScopes) commonClassDao.getEntityItem(PolicyEditorScopes.class,
                                            "scopeName", scope);
                        ...
                        if (configName != null) {
                            if (configName.contains(config)) {
                                ConfigurationDataEntity configuration =
                                        (ConfigurationDataEntity) commonClassDao.getEntityItem(
                                                ConfigurationDataEntity.class, configurationName, configName);
                                policyEntity.setConfigurationData(configuration);
                            } else {
                                ActionBodyEntity actionBody =
                                        (ActionBodyEntity) commonClassDao.getEntityItem(ActionBodyEntity.class,
    ...
    private boolean isAttributeObjectFound(String msService, String msVersion) {
        ...
        List<Object> microServiceModelsData = commonClassDao.getDataById(MicroServiceModels.class, "modelName", msService);
