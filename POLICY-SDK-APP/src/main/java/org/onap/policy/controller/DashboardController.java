...
public class DashboardController extends RestrictedBaseController {
    ...
    public void dashboardAdvancedSearch(HttpServletRequest request, HttpServletResponse response)
            throws IOException {
        String scope = null;
        String stage = "both";
        ...
        try {
            ...
            getPolicyData(scope, stage, isDelected, ttlDateAfter, ttlDateBefore);
            Map<String, Object> model = new HashMap<>();
    ...
    public void addPolicyCRUDInfoToTable() {
        ...
        geParams.put("createdDate", lastThirtyDate.toString());
        ...
        if (datas != null) {
            datas.stream().forEach((data) -> {
                ...
                if (((PolicyEntity) data).getModifiedDate() != null) {
                    ...
                    object.put("createdDate", cts.toString());
                } else {
                    object.put("modifiedDate", "0000-00-00");
                    object.put("createdDate", "0000-00-00");
                }
     ...
     */
    private void getPolicyData(String scope,String stage, String isDeleted, String createdAfter,String createdBefore) {
        policyStatusCrudData = new ArrayList<>();
