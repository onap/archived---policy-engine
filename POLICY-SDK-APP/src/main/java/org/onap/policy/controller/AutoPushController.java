...
public class AutoPushController extends RestrictedBaseController {
    ...
    @RequestMapping(value = {"/get_AutoPushPoliciesContainerData"},
    ...
    @RequestMapping(value = {"/auto_Push/PushPolicyToPDP.htm"},
    ...
    @RequestMapping(value = {"/auto_Push/remove_GroupPolicies.htm"},
            method = {org.springframework.web.bind.annotation.RequestMethod.POST})
