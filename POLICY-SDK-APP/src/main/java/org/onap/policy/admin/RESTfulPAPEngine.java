...
public class RESTfulPAPEngine extends StdPDPItemSetChangeNotifier implements PAPPolicyEngine {
    ...
    public void newGroup(String name, String description) throws PAPException {
        ...
        this.sendToPAP("POST", null, null, null, groupID, "groupName=" + escapedName,
    ...
    public OnapPDPGroup getPDPGroup(String pdpId) throws PAPException {
        return (OnapPDPGroup) sendToPAP("GET", null, null, StdPDPGroup.class, groupID, "pdpId=" + pdpId,
                "getPDPGroup=");
    }
    ...
    public Object sendToPAP(String method, Object content, Class collectionTypeClass, Class responseContentClass,
