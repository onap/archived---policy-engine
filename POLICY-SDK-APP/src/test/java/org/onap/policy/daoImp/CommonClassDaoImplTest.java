...
public class CommonClassDaoImplTest {
    ...
    public void setUp() throws Exception {
        try {
            ...
            SessionFactory sf = CommonClassDaoImpl.getSessionfactory();
            assertTrue(sf instanceof SessionFactory);
    ...
    public void testExceptions() {
        ...
        List<Object> dupEntryList = commonClassDao.checkDuplicateEntry("TestID:Test", "userLoginId:userName", UserInfo.class);
