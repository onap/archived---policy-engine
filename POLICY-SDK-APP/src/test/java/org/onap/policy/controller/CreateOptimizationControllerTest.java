...
public class CreateOptimizationControllerTest {
	...
	public void testStringBetweenDots() {
		...
		CreateOptimizationController controllerA = new CreateOptimizationController();
		...
		CreateOptimizationController controllerB = new CreateOptimizationController();
	...
	@Test
	public void testGetPriorityValuesData() {
		
		logger.debug("testGetPriorityValuesData: enter");
	    ...
	    MockHttpServletResponse response = new MockHttpServletResponse();
        try{
		   controller.getPriorityValuesData(request, response);
		   assertTrue( response.getContentAsString() != null && response.getContentAsString().contains("priorityDatas"));
		   logger.debug("response: "  + response.getContentAsString());
        } catch (Exception e) {
			logger.error("testGetPriorityValuesData", e);
			fail("testGetPriorityValuesData failed due to: " + e);
		}
		
		logger.debug("testGetPriorityValuesData: exit");
	}
