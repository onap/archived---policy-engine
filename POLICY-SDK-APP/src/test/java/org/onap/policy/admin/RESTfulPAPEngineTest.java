...
public class RESTfulPAPEngineTest {
    private static final String NEED_CACHE_FIELD = "needCache";
    ...
    public static void setUpBeforeClass() throws IOException {
        XACMLProperties.getProperties().clear();
        Whitebox.setInternalState(XACMLProperties.class, NEED_CACHE_FIELD, true);
    }
