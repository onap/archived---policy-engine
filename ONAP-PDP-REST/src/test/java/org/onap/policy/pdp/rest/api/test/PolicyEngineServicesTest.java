...
public class PolicyEngineServicesTest {
    ...
    public void pushPolicyTest() throws Exception {
        ...
        // Failure Tests.
        mockMvc.perform(put("/pushPolicy").requestAttr("Mechid", "junit")).andExpect(status().isBadRequest());

        // Service Tests.
        mockMvc.perform(put("/pushPolicy").requestAttr("Mechid", "junit").content(PolicyUtils.objectToJsonString(pep))
                .contentType(MediaType.APPLICATION_JSON).headers(headers).header(UUIDHEADER, UUID.randomUUID()))
                .andExpect(status().isBadRequest());
    ...
    public void deletePolicyTest() throws Exception {
        ...
        // Failure Tests.
        mockMvc.perform(delete("/deletePolicy").requestAttr("Mechid", "junit")).andExpect(status().isBadRequest());

        // Service Tests.
        mockMvc.perform(
                delete("/deletePolicy").requestAttr("Mechid", "junit").content(PolicyUtils.objectToJsonString(pep))
                        .contentType(MediaType.APPLICATION_JSON).headers(headers).header(UUIDHEADER, UUID.randomUUID()))
                .andExpect(status().isBadRequest());
        ...
        mockMvc.perform(delete("/deletePolicy").requestAttr("Mechid", "junit")
    ...
    public void createUpdatePolicyTest() throws Exception {
        ...
        // Failure Tests.
        mockMvc.perform(put("/createPolicy").requestAttr("Mechid", "junit")).andExpect(status().isBadRequest());

        // Service Tests.
        setCreateUpdateImpl();
        mockMvc.perform(put("/createPolicy").requestAttr("Mechid", "junit").content(PolicyUtils.objectToJsonString(pep))
                .contentType(MediaType.APPLICATION_JSON).headers(headers).header(UUIDHEADER, UUID.randomUUID()))
                .andExpect(status().isBadRequest());
    ...
    public void brmsPolicyCreationTests() throws Exception {
        ...
        mockMvc.perform(put("/createPolicy").requestAttr("Mechid", "junit").content(PolicyUtils.objectToJsonString(pep))
                .contentType(MediaType.APPLICATION_JSON).headers(headers)).andExpect(status().isBadRequest());
        mockMvc.perform(put("/updatePolicy").requestAttr("Mechid", "junit").content(PolicyUtils.objectToJsonString(pep))
                .contentType(MediaType.APPLICATION_JSON).headers(headers)).andExpect(status().isBadRequest());
