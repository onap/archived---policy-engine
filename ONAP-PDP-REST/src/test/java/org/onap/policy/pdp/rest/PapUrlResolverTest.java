...
public class PapUrlResolverTest {
    ...
    public void testPropertyModifications() {
        ...
        // first sort order
        String urls =
                "http://one.localhost.com,http://two.localhost.com,http://three.localhost.com,http://four.localhost.com";
    ...
    public void testSorts() {
        ...
        String urls =
                "http://one.localhost.com,http://two.localhost.com,http://three.localhost.com,http://four.localhost.com";
        String failed =
                df.format(new Date(currentTime - 3600000)) + ",-1,-1," + df.format(new Date(currentTime - 3200000));
        ...
        urls = "http://one.localhost.com,http://two.localhost.com,http://three.localhost.com,http://four.localhost.com";
        failed = df.format(new Date(currentTime - 3900000)) + "," + df.format(new Date(currentTime - 5600000)) + ","
                + df.format(new Date(currentTime - 4600000)) + "," + df.format(new Date(currentTime - 3600000));
        succeeded = "-1,-1,-1,-1";
        rs = PapUrlResolver.getInstance(urls, failed, succeeded);
        Assert.assertTrue(rs.hasMoreUrls());
        Assert.assertEquals("http://two.localhost.com", rs.getUrl());
