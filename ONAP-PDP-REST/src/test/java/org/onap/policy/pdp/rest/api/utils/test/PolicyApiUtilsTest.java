...
public class PolicyApiUtilsTest {
    ...
    public void testValidateDirectoryJsonFields() {
        ...
        JsonObject jsonObjAttrGood = Json.createObjectBuilder().add("attributeName", "success").add("type", "REST")
                .add("method", "GET").add("url", "http://foobar.com").add("body", "foobody").build();
        ...
        assertTrue(PolicyApiUtils.validateDictionaryJsonFields(jsonObjectMissingAttrName, dictonaryAction)
        ...
        // null/empty type
        jsonObjAttrGoodTemp = Json.createObjectBuilder().add("attributeName", "success").add("type", "")
                .add("method", "GET").add("url", "http://foobar.com").add("body", "foobody").build();
        assertTrue(PolicyApiUtils.validateDictionaryJsonFields(jsonObjAttrGoodTemp, dictonaryAction)
                .contains("No Type provided"));

        // missing type
        jsonObjAttrGoodTemp = Json.createObjectBuilder().add("attributeName", "success").add("method", "GET")
        ...
        // invalid type
        jsonObjAttrGoodTemp = Json.createObjectBuilder().add("attributeName", "success").add("type", "INVALID")
                .add("method", "GET").add("url", "http://foobar.com").add("body", "foobody").build();
        ...
        // null/empty method
        jsonObjAttrGoodTemp = Json.createObjectBuilder().add("attributeName", "success").add("type", "REST")
                .add("method", "").add("url", "http://foobar.com").add("body", "foobody").build();
        assertTrue(PolicyApiUtils.validateDictionaryJsonFields(jsonObjAttrGoodTemp, dictonaryAction)
        ...
        jsonObjAttrGoodTemp = Json.createObjectBuilder().add("attributeName", "success").add("type", "REST")
                .add("method", "GET").add("url", "http://foobar.com").add("body", "foobody").build();
        assertTrue(
                PolicyApiUtils.validateDictionaryJsonFields(jsonObjAttrGoodTemp, dictonaryAction).contains("success"));

        jsonObjAttrGoodTemp = Json.createObjectBuilder().add("attributeName", "success").add("type", "REST")
                .add("method", "PUT").add("url", "http://foobar.com").add("body", "foobody").build();
        assertTrue(
                PolicyApiUtils.validateDictionaryJsonFields(jsonObjAttrGoodTemp, dictonaryAction).contains("success"));

        jsonObjAttrGoodTemp = Json.createObjectBuilder().add("attributeName", "success").add("type", "REST")
                .add("method", "POST").add("url", "http://foobar.com").add("body", "foobody").build();
        assertTrue(
                PolicyApiUtils.validateDictionaryJsonFields(jsonObjAttrGoodTemp, dictonaryAction).contains("success"));
        ...
        // invalid method
        jsonObjAttrGoodTemp = Json.createObjectBuilder().add("attributeName", "success").add("type", "REST")
                .add("method", "INVALID").add("url", "http://foobar.com").add("body", "foobody").build();
        assertTrue(PolicyApiUtils.validateDictionaryJsonFields(jsonObjAttrGoodTemp, dictonaryAction)
        ...
        // missing url
        jsonObjAttrGoodTemp = Json.createObjectBuilder().add("attributeName", "success").add("type", "REST")
                .add("method", "GET").add("body", "foobody").build();
        assertTrue(PolicyApiUtils.validateDictionaryJsonFields(jsonObjAttrGoodTemp, dictonaryAction)
        ...
        // null body
        jsonObjAttrGoodTemp = Json.createObjectBuilder().add("attributeName", "success").add("type", "REST")
                .add("method", "GET").add("url", "http://foobar.com").add("body", "").build();
        assertTrue(PolicyApiUtils.validateDictionaryJsonFields(jsonObjAttrGoodTemp, dictonaryAction)
                .contains("No Body provided"));

        // missing body
        jsonObjAttrGoodTemp = Json.createObjectBuilder().add("attributeName", "success").add("type", "REST")
                .add("method", "GET").add("url", "http://foobar.com").build();
        assertTrue(PolicyApiUtils.validateDictionaryJsonFields(jsonObjAttrGoodTemp, dictonaryAction)
        ...
        jsonObjAttrGoodTemp = Json.createObjectBuilder().add("attributeName", "success").add("type", "REST")
                .add("method", "GET").add("url", "http://foobar.com").add("body", "foobody")
                .add("headers", jsonArrayHeaders).build();

        assertTrue(PolicyApiUtils.validateDictionaryJsonFields(jsonObjAttrGoodTemp, dictonaryAction)
                .contains("Missing number key in the headers list of the dictionaryJson parameter."));
        ...
        assertTrue(PolicyApiUtils.validateDictionaryJsonFields(jsonObjAttrGoodTemp, dictonaryAction)
                .contains("Missing option key in the headers list of the dictionaryJson parameter."));
