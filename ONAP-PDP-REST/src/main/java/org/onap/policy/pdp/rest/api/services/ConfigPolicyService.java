...
public class ConfigPolicyService {
    ...
    public String getResult(boolean updateFlag) throws PolicyException {
        ...
        // create Policy.
        StdPAPPolicy newPAPPolicy = new StdPAPPolicy("Base", policyName, policyParameters.getPolicyDescription(),
                onapName, configName, configAttributes, configType,
                configBody, updateFlag, policyScope, 0, policyParameters.getRiskLevel(),
