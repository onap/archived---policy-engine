...
/**
 * PolicyEngine is the Interface that applications use to make policy queries
 * against a PEPEngine
 * 
 * @version 2.0
 */
public class PolicyEngine {
	...
	/**
	 * PolicyEngine Constructor with <code>String</code> format of
	 * propertiesFilePathname
	 * 
	 * @param propertiesFilePathname
	 *            the <code>String</code> format of the propertiesFilePathname
	 * @throws PolicyEngineException
	 *             PolicyEngine Exception
	 */
	 ...
	 *            the <code>String</code> format of the propertiesFilePathname
	 * @param clientKey
	 *            depicts String format of Password/ Client_Key.
	 * @throws PolicyEngineException
	 *             PolicyEngine Exception
	 */
	...
	/**
	 * PolicyEngine Constructor with <code>String</code> format of
	 * PropertiesFilePathname and <code>NotificationScheme</code>
	 * 
	 * @param propertiesFilePathname
	 *            the <code>String</code> format of the propertiesFilePathname
	 * @param scheme
	 *            the <code>NotificationScheme</code> of
	 *            {@link org.onap.policy.api.NotificationScheme} which defines
	...
	/**
	 * PolicyEngine Constructor with <code>String</code> format of
	 * PropertiesFilePathname, <code>NotificationScheme</code> and
	 * <code>NotificationHandler</code>
	 * 
	 * @param propertiesFilePathname
	 *            the <code>String</code> format of the propertiesFilePathname
	 * @param scheme
	 ...
	 *            the Notification Scheme
	 * @param handler
	 *            the <code>NotificationHandler</code> of
	 *            {@link org.onap.policy.api.NotificationHandler} which defines
	 *            what should happen when a notification is received.
	 * @throws PolicyEngineException
	 *             PolicyEngine Exception
	 */
	public PolicyEngine(final String propertiesFilePathname, final NotificationScheme scheme, final NotificationHandler handler)
			throws PolicyEngineException {
		this.propertyFilePath = propertiesFilePathname;
		this.scheme = scheme;
	...
	/**
	 * Gets the configuration from the PolicyDecisionPoint(PDP) for the
	 * <code>String</code> which represents the Policy File Name
	 * 
	 * @param policyName
	 *            the <code>String</code> format of the PolicyFile Name whose
	 *            configuration is required.
	 * @return <code>Collection</code> of
	 *         {@link org.onap.policy.api.PolicyConfig} which has the
	 *         configuration.
	 * @throws PolicyConfigException
	 *             PolicyConfig Exception
	 * @deprecated use
	 *             {@link #getConfig(ConfigRequestParameters configRequestParameters)}
	 *             Instead.
	 */
	@Deprecated
	 ...
	 *            configuration is required.
	 * @param requestID
	 *            unique request ID which will be passed throughout the ONAP
	 *            components to correlate logging messages. A different request
	 *            ID should be passed for each request.
	 * @return <code>Collection</code> of
	 *         {@link org.onap.policy.api.PolicyConfig} which has the
	 *         configuration.
	 * @throws PolicyConfigException
	...
	/**
	 * Gets the configuration from the PolicyDecisionPoint(PDP) for the
	 * <code>String</code> which represents the onapName
	 * 
	 * @param onapName
	 *            the <code>String</code> format of the onapName whose
	 *            configuration is required.
	 * @return <code>Collection</code> of
	 *         {@link org.onap.policy.api.PolicyConfig} which has the
	 *         configuration.
	...
	/**
	 * Requests the configuration of the <code>String</code> which represents
	 * the onapName and <code>String</code> which represents the configName and
	 * returns the configuration if different Configurations exist for the
	 * particular onapName.
	 * 
	 * @param onapName
	 *            the <code>String</code> format of the onapName whose
	 *            configuration is required.
	 * @param configName
	 *            the <code>String</code> format of the configurationName whose
	 *            configuration is required.
	 * @return <code>Collection</code> of
	 *         {@link org.onap.policy.api.PolicyConfig} which has the
	 *         configuration.
	...
	/**
	 * Requests the configuration of the <code>String</code> which represents
	 * the onapName, <code>String</code> which represents the configName and
	 * <code>Map</code> of <code>String,String</code> which has the
	 * configAttribute and returns the specific configuration related to the
	 * configAttributes mentioned.
	 * 
	 * @param onapName
	 *            the <code>String</code> format of the onapName whose
	 *            configuration is required.
	 ...
	 *            the <code>Map</code> of <code>String,String</code> format of
	 *            the configuration attributes which are required.
	 * @return <code>Collection</code> of
	 *         {@link org.onap.policy.api.PolicyConfig} which has the
	 *         configuration.
	 * @throws PolicyConfigException
	 ...
	 */
	@Deprecated
	public Collection<PolicyConfig> getConfig(final String onapName, final String configName, final Map<String, String> configAttributes)
			throws PolicyConfigException {
	...
	@Deprecated
	public Collection<PolicyConfig> getConfig(final String onapName, final String configName, final Map<String, String> configAttributes,
			final UUID requestID) throws PolicyConfigException {
		return getConfig(setConfigRequestParameters(null, onapName, configName, configAttributes, requestID));
	}

	/**
	 * Requests the configuration of the <code>ConfigRequestParameters</code>
	 * which represents the Config policy request parameters and returns the
	 * specific configuration related to the matching parameters.
	 * 
	 * @param configRequestParameters
	 *            {@link org.onap.policy.api.ConfigRequestParameters} which
	...
	/**
	 * Requests the list of policies based on the
	 * <code>ConfigRequestParameters</code> which represents the policy request
	 * parameters and returns the list of policies filtered by the parameters.
	 * 
	 * @param configRequestParameters
	 *            {@link org.onap.policy.api.ConfigRequestParameters} which
	 *            represents the List Policy request parameters.
	 * @return <code>Collection</code> of <code>String</code> which returns the
	 *         list of policies.
	 * @throws PolicyConfigException
	 *             PolicyConfig Exception
	 */
	...
	/**
	 * Sends the Events specified to the PEP and returns back the
	 * PolicyResponse.
	 * 
	 * @param eventAttributes
	 *            the <code>Map</code> of <code>String,String</code> format of
	 *            the eventAttributes that must contain the event ID and values.
	 * @return <code>Collection</code> of
	 *         {@link org.onap.policy.api.PolicyResponse} which has the
	 *         Response.
	 * @throws PolicyEventException
	 *             PolicyEvent Exception
	 ...
	 * PolicyResponse.
	 * 
	 * @param eventRequestParameters
	 *            {@link org.onap.policy.api.EventRequestParameters} which
	 *            represents the Event Request Parameters.
	 * @return <code>Collection</code> of
	 *         {@link org.onap.policy.api.PolicyResponse} which has the
	 *         Response.
	 * @throws PolicyEventException
	...
	/**
	 * Sends the decision Attributes specified to the PEP and returns back the
	 * PolicyDecision.
	 * 
	 * @param onapName
	 *            the <code>String</code> format of the onapName whose Decision
	 *            is required.
	 * @param decisionAttributes
	 *            the <code>Map</code> of <code>String,String</code> format of
	 *            the decisionAttributes that must contain the ID and values.
	 * @return {@link org.onap.policy.api.DecisionResponse} which has the
	 *         Decision.
	 * @throws PolicyDecisionException
	 *             PolicyDecision Exception
	 ...
	 */
	@Deprecated
	public DecisionResponse getDecision(final String onapName, final Map<String, String> decisionAttributes, final UUID requestID)
			throws PolicyDecisionException {
	 ...
	 * PolicyDecision.
	 * 
	 * @param decisionRequestParameters
	 *            {@link org.onap.policy.api.DecisionRequestParameters} which
	...
	/**
	 * Retrieves the count of policies on the PAP, PDP, and Policy Engine as a
	 * whole
	 * 
	 * @param parameters
	 *            {@link org.onap.policy.api.MetricsRequestParameters} which
	 *            represents the Parameters required to get the Policy Metrics
	 * @return {@link org.onap.policy.api.MetricsResponse} which consists of the
	 *         response related to getMetrics Request.
	 * @throws PolicyException
	 *             PolicyException related to the operation
	 * 
	 */
	 ...
	 * 
	 * @param policyName
	 *            the <code>String</code> format of the Policy Name
	 * @param policyDescription
	 *            the <code>String</code> format of the Policy Description
	 * @param onapName
	 *            the <code>String</code> format of the ONAP Name
	 * @param configName
	 *            the <code>String</code> format of the Config Name
	 * @param configAttributes
	 *            the <code>List</code> the <code>Map</code> Attributes that
	 *            must contain the key and value.
	 * @param configType
	 *            the <code>String</code> format of the Config Type
	 * @param body
	 *            the <code>String</code> format of the Policy Body
	 * @param policyScope
	 *            the <code>String</code> value of the sub scope directory where
	 *            the policy will be created and stored
	 * @param requestID
	 *            unique request ID which will be passed throughout the ONAP
	 *            components to correlate logging messages. A different request
	 *            ID should be passed for each request.
	 * @param riskLevel
	 *            the <code>String</code> value of risk Level.
	 * @param riskType
	 *            the <code>String</code> value of risk Type.
	 * @param guard
	 *            the <code>String</code> value of guard.
	 * @param ttlDate
	 *            the <code>String</code> value of time to live Date.
	 * @throws PolicyException
	 *             PolicyException related to the operation.
	 ...
	 *            the <code>String</code> format of the Policy Name
	 * @param firewallJson
	 *            the <code>JsonObject</code> representation of the Firewall
	 *            Rules List
	 * @param policyScope
	 *            the <code>String</code> value of the sub scope directory where
	 *            the policy will be created and stored
	 ...
	 */
	@Deprecated
	public String createConfigFirewallPolicy(final String policyName, final JsonObject firewallJson, final String policyScope,
			final UUID requestID, final String riskLevel, final String riskType, final String guard, final String ttlDate) throws PolicyException {
	 ...
	 */
	@Deprecated
	public String updateConfigFirewallPolicy(final String policyName, final JsonObject firewallJson, final String policyScope,
			final UUID requestID, final String riskLevel, final String riskType, final String guard, final String ttlDate) throws PolicyException {
		return stdPolicyEngine.createUpdateConfigFirewallPolicy(policyName, firewallJson, policyScope, requestID,
	 ...
	 * 
	 * @param parameters
	 *            {@link org.onap.policy.api.DictionaryParameters} which
	 *            represents the Dictionary Parameters required to create a
	 *            Dictionary Item.
	 * @return {@link org.onap.policy.api.DictionaryResponse} which consists of
	 *         the response related to create dictionary item Request.
	 * @throws PolicyException
	 *             PolicyException related to the operation
	 * 
	 */
	 ...
	 *            represents the Dictionary Parameters required to create a
	 *            Dictionary Item.
	 * @return {@link org.onap.policy.api.PolicyChangeResponse} which consists
	 *         of the response related to create dictionary item Request.
	 * @throws PolicyException
	 *             PolicyException related to the operation.
	 */
	 ...
	 * @param parameters
	 *            {@link org.onap.policy.api.DictionaryParameters} which
	 *            represents the Dictionary Parameters required to update a
	 *            Dictionary Item.
	 * @return {@link org.onap.policy.api.PolicyChangeResponse} which consists
	 *         of the response related to update dictionary item Request.
	 * @throws PolicyException
	 *             PolicyException related to the operation.
	 */
	 ...
	 *            {@link org.onap.policy.api.PolicyParameters} which represents
	 *            the Policy Parameters required to create a Policy.
	 * @return {@link org.onap.policy.api.PolicyChangeResponse} which consists
	 *         of the response related to create policy Request.
	 * @throws PolicyException
	 *             PolicyException related to the operation.
	 */
	 ...
	 * @param policyParameters
	 *            {@link org.onap.policy.api.PolicyParameters} which represents
	 *            the Policy Parameters required to update a Policy.
	 * @return {@link org.onap.policy.api.PolicyChangeResponse} which consists
	 *         of the response related to create policy Request.
	 * @throws PolicyException
	 *             PolicyException related to the operation.
	...
	/**
	 * Pushes the specified policy to the PDP Group. If no PDP group is selected
	 * default is used.
	 * 
	 * @param policyScope
	 *            the <code>String</code> value of the sub scope directory where
	 ...
	 * @param policyName
	 *            the <code>String</code> format of the Policy Name being
	 *            pushed.
	 * @param policyType
	 *            the <code>String</code> format of the Policy Type which is
	 *            being pushed.
	 * @param pdpGroup
	 *            the <code>String</code> format of the PDP Group name to which
	 *            the policy needs to be pushed to.
	 * @param requestID
	 *            unique request ID which will be passed throughout the ONAP
	 *            components to correlate logging messages.
	 * @return <code>String</code> format of the response related to the push
	 *         Policy Request.
	 * @throws PolicyException
	 *             PolicyException related to the operation.
	 ...
	 */
	@Deprecated
	public String pushPolicy(final String policyScope, final String policyName, final String policyType, final String pdpGroup, final UUID requestID)
			throws PolicyException {
	 ...
	 * default is used.
	 * 
	 * @param pushPolicyParameters
	 *            {@link org.onap.policy.api.PushPolicyParameters} which
	 *            represents the Push Policy parameters required to push a
	 *            policy.
	 * @return {@link org.onap.policy.api.PolicyChangeResponse} which consists
	 *         of the response related to the push Policy Request.
	 * @throws PolicyException
	 *             PolicyException related to the operation.
	 */
	 ...
	 *            {@link org.onap.policy.api.DeletePolicyParameters} which
	 *            represents the Delete Policy parameters to delete a policy.
	 * @return {@link org.onap.policy.api.PolicyChangeResponse} which consists
	 *         of the response related to the Delete Policy Request.
	 * @throws PolicyException
	 *             PolicyException related to the operation.
	 */
	 ...
	 *            {@link org.onap.policy.api.ImportParameters} which represents
	 *            the Service Parameters required to create a Policy Service.
	 * @return {@link org.onap.policy.api.PolicyChangeResponse} which consists
	 *         of the response related to create import Service.
	 * @throws PolicyException
	 *             PolicyException related to the operation.
	 */
	...
	/**
	 * <code>clearNotification</code> shutsDown the Notification Service if the
	 * Auto Scehme Notification service is running.
	 */
	...
	/**
	 * Gets the <code>PDPNotification</code> if there is one exists. This is
	 * used for Polling Patterns.
	 * 
	 * @return <code>PDPNotification</code> of
	 *         {@link org.onap.policy.api.PDPNotification} which has the
	 *         Notification.
	 */
	...
	/**
	 * setClientKey allows the client to use their own implementation logic for
	 * Password Protection and will be used to set the clear text password, this
	 * will be used while making Requests.
	 * 
	 * @param clientKey
	 *            depicts String format of Password/ Client_Key.
	 */
	...
	private ConfigRequestParameters setConfigRequestParameters(final String policyName, final String onapName, final String configName,
			final Map<String, String> configAttributes, final UUID requestID) {
