...
public class ManualClientEndDMAAP {
    ...
    public static void start(List<String> dmaapList, String topic, String aafLogin, String aafPassword, String uniqueID) {
        ...
        int count = 1;
        while (count < 4) {
            count = publishMessageAndSetNotification(dmaapList, topic, aafLogin, aafPassword, count);
        }
    }

    private static int publishMessageAndSetNotification(List<String> dmaapList, String topic, String aafLogin, String aafPassword, int count) {
        publishMessage(topic, uniquID, dmaapList, aafLogin, aafPassword);
        try {
