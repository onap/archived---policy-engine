...
public class PolicyRestAdapter {
	...
	/*
	 * 
	 * Note : Make Sure if any variables are added in PolicyRestAdapter.java,
	 * add them to PolicyElasticData.java file
	 * 
	 * 
	 */
	...
	/**
	 * @param dynamicRuleAlgorithmLabels
	 *            the dynamicRuleAlgorithmLabels to set
	 */
	...
	/**
	 * @param dynamicRuleAlgorithmCombo
	 *            the dynamicRuleAlgorithmCombo to set
	 */
	...
	/**
	 * @param dynamicRuleAlgorithmField1
	 *            the dynamicRuleAlgorithmField1 to set
	 */
	...
	/**
	 * @param dynamicRuleAlgorithmField2
	 *            the dynamicRuleAlgorithmField2 to set
	 */
