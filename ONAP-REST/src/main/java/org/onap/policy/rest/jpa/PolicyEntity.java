 ...
 */
@Entity
// Add a non-unique index and a constraint that says the combo of policyName and
...
public class PolicyEntity implements Serializable {
	...
	// The scope is the directory structure in dot notation. For example:
	// org.onap.myproject
	 ...
	 *            the configurationDataEntity to set
	 */
	public void setConfigurationData(
			ConfigurationDataEntity configurationDataEntity) {
	...
	/**
	 * @param actionBodyEntity
	 *            the actionBodyEntity to set
	 */
	...
	@Override
	public int hashCode() {
		return Objects.hash(policyId, policyName, scope, version,
				policyVersion, policyData, configurationDataEntity,
				actionBodyEntity, createdBy, createdDate, description,
				modifiedBy, modifiedDate, deleted);
	}
	...
	public boolean equals(Object obj) {
		...
		return policyId == p.policyId
				...
				&& ((configurationDataEntity == null && p.configurationDataEntity == null) || (configurationDataEntity != null && configurationDataEntity
						.equals(p.configurationDataEntity)))
				&& ((actionBodyEntity == null && p.actionBodyEntity == null) || (actionBodyEntity != null && actionBodyEntity
						.equals(p.actionBodyEntity)))
				...
				&& modifiedDate.equals(p.modifiedDate) && deleted == p.deleted;
	}
