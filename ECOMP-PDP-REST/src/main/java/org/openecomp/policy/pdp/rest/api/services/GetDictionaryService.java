...
public class GetDictionaryService {
    ...
    private String formatDictionaryJson(String result) {
        ...
        case "Term":
            ...
            break;
        case "EventAlarm":
            jsonString = jsonString.replace("gocEventAlarmDictionaryDatas", "DictionaryDatas");
            break;
        case "Traversal":
            jsonString = jsonString.replace("gocTraversalDictionaryDatas", "DictionaryDatas");
            break;
        case "RootCauseAlarm":
            jsonString = jsonString.replace("gocRCAlarmDictionaryDatas", "DictionaryDatas");
            break;
        case "GocVnfType":
            jsonString = jsonString.replace("gocVnfTypeDictionaryDatas", "DictionaryDatas");
            break;
        case "ServerScopeMapping":
            jsonString = jsonString.replace("gocServerScopeDictionaryDatas", "DictionaryDatas");
            break;
        case "HPEventSourceName":
            jsonString = jsonString.replace("gocHPEventSourceDatas", "DictionaryDatas");
            break;
