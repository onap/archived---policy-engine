...
var editPDPGrouppopupController =  function ($scope, $modalInstance, message, modalService, $modal, Notification){
	...
	$scope.pdpsGrid = {
		...
		columnDefs: [{
			...
			'<button  type="button"  class="btn btn-success" ng-click="grid.appScope.statusOfPDP(row.entity.status)" >Status</button>',  width: '15%'
		},
