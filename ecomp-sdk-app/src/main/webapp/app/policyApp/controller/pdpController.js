...
app.controller('pdpTabController', function ($scope,PDPService,modalService, $modal, AdminTabService){
	$( "#dialog" ).hide();
	 ...
	 AdminTabService.getData().then(function(data){
		 ...
		 AdminTabService.getRolesData().then(function(data) {
			 var j = data;
			 $scope.data = JSON.parse(j.data);
			 console.log($scope.data);
			 ...
			 PDPService.getPDPGroupEntityData().then(function(data){
				 var j = data;
