...
var mainDictionarys = ["Action Policy", "BRMS Policy", "Common Dictionary", "ClosedLoop Policy","Decision Policy", "Descriptive Policy",
	"Enforcer Policy", "Firewall Policy", "MicroService Policy", "Policy Scope", "Safe Policy Dictionary"];
var subDictionarys = [["Action Dictionary"],
	...
	["Descriptive Scope"],
	["Enforcer Dictionary"],
	["Action List", "Address Group", "Parent Dictionary List", "Port List", "Prefix List", "Protocol List", "Security Zone", "Service Group", "Service List", "Term List", "Zone"],
	["DCAE UUID","MicroService ConfigName","MicroService Location", "MicroService Models"],
	["Closed Loop", "Group Policy Scope", "Resource", "Service", "Type"],
	["Risk Type", "Safe Policy Warning"]];
app.controller('dictionaryTabController', function ($scope, AdminTabService, modalService, $modal){
	$( "#dialog" ).hide();
