...
/**
 */
app.controller('varbindDictGridController', function ($scope, PapUrlService, CLDictionaryService,modalService, $modal){
    $( "#dialog" ).hide();
	...
	PapUrlService.getPapUrl().then(function(data) {
	    ...
	    CLDictionaryService.getVarbindDictionaryData(papUrl).then(function (data) {
	        var j = data;
    ...
    $scope.varbindDictionaryGrid = {
        ...
        columnDefs: [{
            ...
            { field: 'varbindName', displayName : 'Varbind Name'},
    		...
    		success : function(resultList){
    			...
    			if($scope.success){
    				modalService.popupConfirmWin("Confirm","You are about to delete the Varbind Dictionary  "+data.varbindName+". \n "+searchString+" \n Do you want to continue?",
    						function(){
    					var uuu = papUrl + "/ecomp/cl_dictionary/remove_varbindDict.htm";
