...
/**
 */
app.controller('vnfTypeDictGridController', function ($scope, PapUrlService, CLDictionaryService,modalService, $modal){
    $( "#dialog" ).hide();
	...
	PapUrlService.getPapUrl().then(function(data) {
	    ...
	    CLDictionaryService.getVnfTypeDictionaryData(papUrl).then(function (data) {
	        var j = data;
    ...
    $scope.vnfTypeDictionaryGrid = {
        ...
        columnDefs: [{
            ...
            { field: 'vnftype', displayName : 'VNF Type'},
            { field: 'description'},
    		...
    		success : function(resultList){
    			...
    			if($scope.success){
    				modalService.popupConfirmWin("Confirm","You are about to delete the Vnf Type Dictionary Item  "+data.vnftype+". \n "+searchString+" \n Do you want to continue?",
    						function(){
    					var uuu = papUrl + "/ecomp/cl_dictionary/remove_vnfType.htm";
