...
/**
 */
app.controller('termListDictGridController', function ($scope, FWDictionaryService,modalService, $modal, PapUrlService){
    $( "#dialog" ).hide();
	...
	PapUrlService.getPapUrl().then(function(data) {
		...
		FWDictionaryService.getTermListDictionaryData(papUrl).then(function (data) {
	        var j = data;
    ...
    $scope.termListDictionaryGrid = {
        ...
        },{ field: 'termName', displayName : 'Term-Name'},
    ...
    $scope.deleteFWTermList = function(data) {
        modalService.popupConfirmWin("Confirm","You are about to delete the TermList  "+data.termName+". Do you want to continue?",
            function(){
                var uuu = papUrl + "/ecomp/fw_dictionary/remove_termList.htm";
