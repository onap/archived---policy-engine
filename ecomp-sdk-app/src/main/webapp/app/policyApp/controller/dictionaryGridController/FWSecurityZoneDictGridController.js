...
/**
 */
app.controller('securityZoneDictGridController', function ($scope, FWDictionaryService,modalService, $modal, PapUrlService){
    $( "#dialog" ).hide();
	...
	PapUrlService.getPapUrl().then(function(data) {
		...
		FWDictionaryService.getSecurityZoneDictionaryData(papUrl).then(function (data) {
	        var j = data;
    ...
    $scope.securityZoneDictionaryGrid = {
        ...
        },{ field: 'zoneName', displayName : 'Zone Name'},
    ...
    $scope.deleteFWSecurityZone = function(data) {
        modalService.popupConfirmWin("Confirm","You are about to delete the Security Zone  "+data.zoneName+". Do you want to continue?",
            function(){
                var uuu = papUrl + "/ecomp/fw_dictionary/remove_securityZone.htm";
