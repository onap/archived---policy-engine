...
/**
 */
app.controller('descriptiveDictGridController', function ($scope, DictionaryService,modalService, $modal, PapUrlService){
    $( "#dialog" ).hide();
	...
	PapUrlService.getPapUrl().then(function(data) {
	    ...
	    DictionaryService.getDescriptiveDictionaryData(papUrl).then(function (data) {
	        var j = data;
    ...
    $scope.descriptiveDictionaryGrid = {
        ...
        },{ field: 'scopeName', displayName : 'Descriptive Scope Name'},
    ...
    $scope.deleteDescriptiveScope = function(data) {
        modalService.popupConfirmWin("Confirm","You are about to delete the Descriptive Scope :   "+data.scopeName+". Do you want to continue?",
            function(){
                var uuu = papUrl + "/ecomp/descriptive_dictionary/remove_descriptiveScope.htm";
