...
/**
 */
app.controller('safePolicyWarningDictGridController', function ($scope, SafePolicyService,modalService, $modal, PapUrlService){
    $( "#dialog" ).hide();
	...
	PapUrlService.getPapUrl().then(function(data) {
		...
		SafePolicyService.getSafePolicyWarningDictionaryData(papUrl).then(function (data) {
	        var j = data;
    ...
    $scope.safePolicyWarningDictionaryGrid = {
        ...
        },{ field: 'name', displayName : 'Safe Policy Warning Name'},
    ...
    $scope.deleteSafePolicyWarning = function(data) {
        modalService.popupConfirmWin("Confirm","You are about to delete the Safe Policy Warning  "+data.name+". Do you want to continue?",
            function(){
                var uuu = papUrl + "/ecomp/sp_dictionary/remove_SafePolicyWarning.htm";
