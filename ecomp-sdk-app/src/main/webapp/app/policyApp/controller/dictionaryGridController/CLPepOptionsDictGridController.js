...
/**
 */
app.controller('pepOptionsDictGridController', function ($scope, PapUrlService, CLDictionaryService,modalService, $modal){
    $( "#dialog" ).hide();
	...
	PapUrlService.getPapUrl().then(function(data) {
	    ...
	    CLDictionaryService.getPepOptionsDictionaryData(papUrl).then(function (data) {
	        var j = data;
    ...
    $scope.pepOptionsDictionaryGrid = {
        ...
        columnDefs: [{
            ...
            { field: 'pepName', displayName : 'PEP Name'},
    		...
    		success : function(resultList){
    			...
    			if($scope.success){
    				modalService.popupConfirmWin("Confirm","You are about to delete the PEP Options :  "+data.pepName+". \n "+searchString+" \n  Do you want to continue?",
    						function(){
    					var uuu = papUrl + "/ecomp/cl_dictionary/remove_pepOptions.htm";
