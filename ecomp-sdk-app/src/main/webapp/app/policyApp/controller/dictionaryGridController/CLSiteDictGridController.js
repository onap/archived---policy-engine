...
/**
 */
app.controller('siteDictGridController', function ($scope, PapUrlService, CLDictionaryService,modalService, $modal){
    $( "#dialog" ).hide();
	...
	PapUrlService.getPapUrl().then(function(data) {
	    ...
	    CLDictionaryService.getSiteDictionaryData(papUrl).then(function (data) {
	        var j = data;
    		...
    		success : function(resultList){
    			...
    			if($scope.success){
    				modalService.popupConfirmWin("Confirm","You are about to delete the Site Dictionary :  "+data.siteName+". \n "+searchString+" \n Do you want to continue?",
    						function(){
    					var uuu = papUrl + "/ecomp/cl_dictionary/remove_site.htm";
